    ...
    constructor(logName) {
        ...
        */
        ...
        this._writeLogLine = (type, ...args) => {
            ...
            ////////// à remove sur la prod //////////
            if(callerLine.startsWith("\\Serveur bancaire")) callerLine = callerLine.replace("\\Serveur bancaire","<root>")
        ...
        */
        ...
        if(configuration.logOnStart) this._writeLogLine("info",`Starting logger for file '${this.callerFile.filePath.replace("c:\\Users\\Sylicium\\Documents\\DirtyBiologystan\\Projets\\Monnaie\\Serveur bancaire","<root>\\")}'`)
